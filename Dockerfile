...
RUN curl 'https://storage.googleapis.com/golang/go1.7.1.linux-amd64.tar.gz' | tar -xvzf - -C /usr/local

RUN dnf install -y libpcap.x86_64 libpcap.i686 libpcap-devel.x86_64 libpcap-devel.i686 mingw32-wpcap.noarch mingw64-wpcap.noarch
